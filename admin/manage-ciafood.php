<?php include('partials/menuciacons.php'); ?>
...
<div class="main-content">
    <div class="wrapper">
        ...
        <div class="btn-container">
            <a href="<?php echo SITEURL; ?>admin/add-ciafood.php" class="btn-secondary">Add Food</a>
        </div>
        ...
        <table class="tbl-full">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM tbl_food WHERE category_id = 3";
                ...
                if ($res) {
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL; ?>admin/update-ciafood.php?id=<?php echo $id; ?>" class="btn-secondary">Update Food</a>
                                <a href="<?php echo SITEURL; ?>admin/delete-ciafood.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger">Delete Food</a>
                            </td>
