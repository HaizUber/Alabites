...
include('partials/menugraciouslycons.php');
    ...
    <div class="wrapper">
                ...
                <tr>
                    ...
                    <td>
                        <select name="category">
                            <?php
                            $sql = "SELECT * FROM tbl_category WHERE id = 2";
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != "") {
                    ...
                    if ($upload == false) {
                        ...
                        header('location:' . SITEURL . 'admin/add-graciouslyfood.php');
                        exit();
                    }
                }
            } else {
            ...
            if ($res) {
                ...
                header('location: manage-graciouslyfood.php');
            } else {
                $_SESSION['add'] = "<div class='error'>Failed to Add Food.</div>";
                header('location: add-graciouslyfood.php');
            }
        }
        ?>
    </div>
