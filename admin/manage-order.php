    ...
    <div class="wrapper">
        ...
        if (isset($_GET['search_by_reference'])) {
            ...
            if (!empty($search_reference)) {
                $reference_search_condition = " AND customer_address = '$search_reference'";
            }
        }
        ...
        $sql = "SELECT *
            FROM tbl_order
            WHERE 1" . $status_filter_condition . $date_filter_condition . $reference_search_condition . " " . $sort_by_condition;
                        ...
                        while ($row = mysqli_fetch_assoc($result)):
                            ...
                            if ($status === 'Paid') {
                                ...
                                if (!$row['processed']) {
                                    ...
                                    $update_food_sql = "UPDATE tbl_food SET sold = sold + $qty, Stocks = Stocks - $sold WHERE title = '$escaped_food'";
                                ...
                                <td>
                                    <?php if ($status !== 'Paid'): ?>
                                        <form action="" method="POST">
                                            ...
                                            <select name="status">
                                                <option <?php echo $status === "Pending Order" ? "selected" : ""; ?> value="Pending Order">Pending</option>
                                                <option <?php echo $status === "Paid" ? "selected" : ""; ?> value="Paid">Paid</option>
